---
title: AFE 声学前端算法框架 - ESP32-S3 -  — ESP-SR latest 文档
source: https://docs.espressif.com/projects/esp-sr/zh_CN/latest/esp32s3/audio_front_end/README.html
author:
  - esp32 AFE算法
published:
created: 2026-07-07
...
[\[English\]](https://docs.espressif.com/projects/esp-sr/en/latest/esp32s3/audio_front_end/README.html)
...
![概述](https://docs.espressif.com/projects/esp-sr/zh_CN/latest/esp32s3/_images/AFE_SR_overview.png)

### 语音通话

![概述](https://docs.espressif.com/projects/esp-sr/zh_CN/latest/esp32s3/_images/AFE_VOIP_overview.png)
...
根据 `menuconfig` -> `ESP Speech Recognition` 选择需要的AFE的模型，比如WakeNet模型，VAD模型， NS模型等，然后在代码中使用以下步骤调用AFE框架。 代码可以参考 [test\_apps/esp-sr/main/test\_afe.cpp](https://github.com/espressif/esp-sr/blob/7ff63a7/test_apps/esp-sr/main/test_afe.cpp) 或是 or [esp-skainet/examples](https://github.com/espressif/esp-skainet/tree/master/examples).。
...
关于AFE的资源占用情况，请参阅 [资源占用](https://docs.espressif.com/projects/esp-sr/zh_CN/latest/esp32s3/benchmark/README.html) 。